    ...
    return (
        <div className="flex justify-between">
            <div className="pt-14">
                ...
                <a className="py-3 px-5 pt-4 rounded-xl font-itc-avant-garde-gothic-pro" style={{backgroundColor: "#163300", color: "#9FE870"}} href={"https://www.linkedin.com/in/michael-rausch-13445b8a/"} target="_blank" rel="noreferrer">LinkedIn</a>
